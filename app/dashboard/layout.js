...
const SearchIcon = () => <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>;
      ...
      <div className="dash-main">
        <header className="dash-topbar">
          <div className="dash-topbar-left">
            ...
            <form className="top-search-wrap" method="GET" action="/dashboard/cases">
              <SearchIcon />
              <input type="text" name="q" className="top-search-input" placeholder="Search cases…" />
            </form>
          </div>
